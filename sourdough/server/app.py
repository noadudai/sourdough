...
from sourdough.server.actions import RefrigerationAction
from sourdough.server.messages import PerformActionsMessage
...
def adding_a_refrigerator_action():
    ...
    session.commit()
#    action = RefrigerationAction(in_or_out)
